        ...
        <header>
			<div className="swapper">
		        ...
		        <nav className='navbar-footer'>
		        	<ul>
		        		<li>
			        		<NavLink to="/" exact>Акции</NavLink>
		        		</li>
		        		<li>
