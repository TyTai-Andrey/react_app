...
export default function Navbar() {
    ...
    return (
        	...
        	<div className='navbar-header'>
	        	...
	        	<div className="phone-text">Звоните с 8 до 23!</div>
	        	</div>
